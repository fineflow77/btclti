            ...
            <div className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
                ...
                <div className="text-center">
                    ...
                    <p className={`${typography.body} ${colors.textSecondary} max-w-3xl mx-auto`}>
                        元トレーダーのリュウです。NISAやiDeCoで投資を始め、さらなる資産形成を目指したいと考えているあなたへ。ビットコインは、長期的な視点で成長が期待されるデジタル資産として注目されています。しかし、価格の変動に不安を感じる方も多いのではないでしょうか。私自身、2017年にビットコイン投資を始めた当初、株式投資と同じ短期トレードの手法で挑み、1週間で価格が30%下落して資金の半分を失うという苦い失敗を経験しました。その後、値動きを徹底的に研究し、長期投資の知恵を身につけた私が、初心者でも安心して始められる方法をお伝えします。まずはシミュレーターで、あなたの資産形成プランを試してみませんか？
                    </p>
                    <div className="mt-5">
                        <Link
                ...
                <div className={`${colors.cardBg} p-6 rounded-2xl shadow-md ${colors.cardBorder}`}>
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mb-4">
                        <div className="bg-gray-700 bg-opacity-50 p-4 rounded-lg">
                            ...
                            <p className="text-sm">
                                最大2,100万枚しか発行されません。円やドル（法定通貨、「フィアット」）と違い増えないため、抜群の希少性があります。
                            </p>
                        </div>
                        <div className="bg-gray-700 bg-opacity-50 p-4 rounded-lg">
                        ...
                        <div className="bg-gray-700 bg-opacity-50 p-4 rounded-lg">
                            ...
                            <p className="text-sm">
                                発行量が限られているため、価値の保存に最適。「デジタルゴールド」とも呼ばれます。
                            </p>
                        </div>
                    </div>
                ...
                <div className={`${colors.cardBg} p-6 rounded-2xl shadow-md ${colors.cardBorder}`}>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <ul className={`${typography.body} ${colors.textSecondary} list-disc list-inside space-y-2`}>
                                <li>
                                    <strong>成長の可能性</strong>：ビットコインはまだまだ普及の初期段階にあります。企業や機関投資家、そして国家の参入が進むことでさらなる価値向上が期待されます。
                                </li>
                                <li>
                                    <strong>インフレ対策</strong>：円やドルなど（法定通貨、「フィアット」）と異なり、発行量が限られているため、インフレによる価値の減少リスクが低い資産です。
                                </li>
                                <li>
                    ...
                    <div className="bg-blue-900 bg-opacity-20 p-4 rounded-lg mt-6 border border-blue-800">
                        <p className={`${typography.body} text-center ${colors.textPrimary}`}>
                            ビットコインの利益は総合課税の対象となり、最大55%の税率が適用される場合があります。ただし、分離課税が導入される見込みが高くなってきています。パワーロー（Power Law）に基づく長期的な成長パターンを知ることで、腰を据えた投資が可能になります。詳しくはパワーロー解説ページをご覧ください。
                        </p>
