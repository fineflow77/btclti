            ...
            <div className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <header className="mb-12 text-center">
                    ...
                    <p className={`${typography.body} ${colors.textSecondary}`}>
                        元トレーダーのリュウです。2017年、ビットコイン投資を始めた当初、私は株式投資と同じ短期トレードの手法で挑みました。しかし、1週間で価格が30%下落し、資金の半分を失うという苦い失敗を経験しました。「このままではいけない」と、値動きを徹底的に研究した結果、パワーロー（Power Law）という長期的な成長パターンにたどり着きました。パワーローは、データに基づく科学的なアプローチで、価格のトレンドを読み解く強力なツールです。暴落局面でも焦る必要はありません。私の経験とデータ分析を通じて、未来を見据えた投資戦略を一緒に考えましょう。まずはシミュレーターで、あなたの投資プランを試してみませんか？
                    </p>
                    <div className="mt-5">
                        <Link
